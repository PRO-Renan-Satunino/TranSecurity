"""
Nome do arquivo: menu_principal_view.py
...
from views.saidas_view import SaidaView
...
class MenuPrincipalView(tk.Tk):
    def __init__(self):
        ...
        tk.Button(self, text="Registro de Saída", width=25, command=self.abrir_saida).pack(pady=5)
